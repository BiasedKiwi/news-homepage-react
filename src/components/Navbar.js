...
export default function Navbar() {
    return (
        <nav class="mx-auto max-w-7xl mt-20 mb-16">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <a
                        href="#"
                        class="text-[#5d5f79] mr-8 font-sans hover:text-[#f15e50] duration-100"
                        >Home</a
                    >
                    <a
                        href="#"
                    ...
                    <a
                        href="#"
                        class="text-[#5d5f79] font-sans hover:text-[#f15e50] duration-100"
                        >Categories</a
                    >
                </div>
            </div>
